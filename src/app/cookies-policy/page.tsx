export default function Cookies() {
    ...
    return (
        <>
            <main>
                <div className="flex flex-col justify-center items-center w-full p-[2vh] xl:p-[2vw]">
                    ...
                    <p>Cookies do not typically contain any information that personally identifies a user, but personal
                        ...
                        Privacy Policy, if and when We make it available within the Website or on our website.</p>
                    ...
                    <ul>
                        <li><strong>Company</strong> (referred to as either &quot;the
                            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to
                            ArtGrind.
                        </li>
                        ...
                        <li><strong>Website</strong> refers to ArtGrind, accessible from <a href="artgrind.art"
                                                                                            rel="external nofollow noopener"
                                                                                            target="_blank">artgrind.art</a>.
                        </li>
                    ...
                    <p>Where required by law, We will request your consent before using Cookies that are not strictly necessary.
                        Strictly necessary Cookies are used to provide the Website and cannot be switched off in our
                        systems.</p>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>For the Microsoft Edge browser, please visit this page from Microsoft: <a
                                href="https://support.microsoft.com/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09"
                                rel="external nofollow noopener"
                                target="_blank">https://support.microsoft.com/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09</a>
                            </p>
                        </li>
                        <li>
                    ...
                    <p>We may update this Cookies Policy from time to time. The &quot;Last updated&quot; date at the top
                        indicates when it was last revised.</p>
                    <h3>Contact Us</h3>
                    <p>If you have any questions about this Cookies Policy, You can contact us:</p>
                    <ul>
                        <li>By email: hello@jooeonpark.com</li>
                    </ul>
                </div>
            </main>
        </>
